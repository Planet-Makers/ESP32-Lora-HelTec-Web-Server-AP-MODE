...
<html>
  <head>
    <title>Guarian-X9 WEB SERVER</title>
  ...
  <body>
    <div class="topnav">
      <h3>Guardian-X9 WEB SERVER</h3>
    </div>
    
    <br>
    
    <!-- __ MONITORAMENTO E CONTROLE DOS SLAVES ____________________________________________________________________________________________ -->
    <div class="content">
      <div class="cards">
        
        <!-- == Monitoramento e controle Guardian Slave 1 =========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">GUARDIAN SLAVE 1</h3>
          </div>
          
          <!-- Exibe os valores de umidade e temperatura recebidos de Slave 1. *** -->
          <h4 class="temperatureColor">TEMPERATURA</h4>
          <p class="temperatureColor"><span class="reading"><span id="temp_Slave_1"></span> &deg;C</span></p>
          <h4 class="humidityColor">HUMIDADE</h4>
          <p class="humidityColor"><span class="reading"><span id="humd_Slave_1"></span> &percnt;</span></p>
          <!-- *********************************************************************** -->
          
          <!-- COMANDOS PARA O Slave 1. ************************** -->
          <div style="position:relative;">
            <div style="position:relative; float: left;top: 3px;width: 47%;left: 0px;text-align: right;">
              <span class="LEDColor" style="font-weight:bold;">SENSOR 1 : </span>
            </div>
            <div style="position:relative; float: right;width: 51%; right: 0px;">
              ...
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Inverter o estado de alternância.</span>
            ...
            <div style="position:relative; float: left;top: 18px;width: 47%;left: 0px; text-align: right;">
              <span class="LEDColor" style="font-weight:bold;">SENSOR 2 : </span>
            </div>
          ...
          <!-- Mostra outras informações recebidas de Slave 1. ************************ -->
          <p class="statusreadColor"><b><span>ULTIMO DADOS RECEBIDO : </span><span id="LTRD_Slave_1"></span></b></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR DE LEITURA DHT11 : </span><span id="status_read_DHT11_Slave_1"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 1 : </span><span id="LED_1_State_Slave_1"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 2 : </span><span id="LED_2_State_Slave_1"></span></p>
          <!-- *********************************************************************** -->
        </div>
        <!-- ======================================================================================================= -->
        
        <!-- == Monitoramento e controle da ESP32 Slave 2 ========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">GUARDIAN SLAVE 2</h3>
          </div>
          
          <!-- Exibe os valores de umidade e temperatura recebidos de Slave 2. *** -->
          <h4 class="temperatureColor">TEMPERATURA</h4>
          ...
          <!-- Mostra outras informações recebidas de Slave 2. ************************ -->
          <p class="statusreadColor"><b><span>ULTIMO DADOS RECEBIDO  : </span><span id="LTRD_Slave_2"></span></b></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR DHT11 : </span><span id="status_read_DHT11_Slave_2"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 1 : </span><span id="LED_1_State_Slave_2"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 2 : </span><span id="LED_2_State_Slave_2"></span></p>
          <!-- *********************************************************************** -->
        </div>  
        <!-- ======================================================================================================= -->
        
        <!-- == Monitoramento e controle Guardian Slave 3 =========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">GUARDIAN SLAVE 3</h3>
          </div>
          
          <!-- Exibe os valores de umidade e temperatura recebidos de Slave 3. *** -->
          <h4 class="temperatureColor">TEMPERATURA</h4>
          ...
          <div style="position:relative;">
            ...
            <div style="position:relative; float: right;width: 51%; right: 0px;">
              ...
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Inverter o estado de alternância.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_1_Slave_3')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
            ...
            <div style="position:relative;float: right; width: 51%;right: 0px; top: 5px;">
              ...
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Inverter o estado de alternância.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_2_Slave_3')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
          </div>
          <!-- *********************************************************************** -->
          ...
          <!-- outras informações recebidas de Slave 3. ************************ -->
          <p class="statusreadColor"><b><span>ULTIMO DADOS RECEBIDO : </span><span id="LTRD_Slave_3"></span></b></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR DHT11 : </span><span id="status_read_DHT11_Slave_3"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR SENSOR 1 : </span><span id="LED_1_State_Slave_3"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR SENSOR 2 : </span><span id="LED_2_State_Slave_3"></span></p>
          <!-- *********************************************************************** -->
        </div>
        <!-- ======================================================================================================= -->

        <!-- == Monitoramento e controle Guardian Slave 4 =========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">GUARDIAN SLAVE 4</h3>
          </div>
          
          <!-- Displays the humidity and temperature values received from Slave 4. *** -->
          <h4 class="temperatureColor">TEMPERATURA</h4>
          <p class="temperatureColor"><span class="reading"><span id="temp_Slave_1"></span> &deg;C</span></p>
          <h4 class="humidityColor">HUMIDADE</h4>
          <p class="humidityColor"><span class="reading"><span id="humd_Slave_1"></span> &percnt;</span></p>
          ...
          <!-- Buttons for controlling the LEDs on Slave 4. ************************** -->
          <div style="position:relative;">
            <div style="position:relative; float: left;top: 3px;width: 47%;left: 0px;text-align: right;">
            ...
            <div style="position:relative; float: right;width: 51%; right: 0px;">
              <div style="position:relative; float: left;">
                <label class="switch">
                  <input type="checkbox" id="togLED_1_Slave_4" onclick="send_LED_State('togLED_1_Slave_4','S4','1')">
                  <div class="sliderTS"></div>
                </label>
              </div>
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Invert the toggle button state.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_1_Slave_4')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
            ...
            <div style="position:relative;float: right; width: 51%;right: 0px; top: 5px;">
              <div style="position:relative; float: left;">
                <label class="switch">
                  <input type="checkbox" id="togLED_2_Slave_4" onclick="send_LED_State('togLED_2_Slave_4','S4','2')">
                  <div class="sliderTS"></div>
                </label>
              </div>
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Invert the toggle button state.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_2_Slave_4')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
          </div>
          <!-- *********************************************************************** -->
          ...
          <!-- Shows other information received from Slave 4. ************************ -->
          <p class="statusreadColor"><b><span>ULTIMO DADOS RECEBIDO : </span><span id="LTRD_Slave_4"></span></b></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR DHT11 : </span><span id="status_read_DHT11_Slave_4"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 1 : </span><span id="LED_1_State_Slave_4"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 2 : </span><span id="LED_2_State_Slave_4"></span></p>
          <!-- *********************************************************************** -->
        </div>
        <!-- ======================================================================================================= -->

        <!-- == Monitoramento e controle Guardian Slave 5 =========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">GUARDIAN SLAVE 5</h3>
          </div>
          
          <!-- Displays the humidity and temperature values received from Slave 5. *** -->
          <h4 class="temperatureColor">TEMPERATURA</h4>
          <p class="temperatureColor"><span class="reading"><span id="temp_Slave_1"></span> &deg;C</span></p>
          <h4 class="humidityColor">HUMIDADE</h4>
          <p class="humidityColor"><span class="reading"><span id="humd_Slave_1"></span> &percnt;</span></p>
          ...
          <!-- Buttons for controlling the LEDs on Slave 5. ************************** -->
          <div style="position:relative;">
            <div style="position:relative; float: left;top: 3px;width: 47%;left: 0px;text-align: right;">
              <span class="LEDColor" style="font-weight:bold;">LED 1 : </span>
            </div>
            <div style="position:relative; float: right;width: 51%; right: 0px;">
              <div style="position:relative; float: left;">
                <label class="switch">
                  <input type="checkbox" id="togLED_1_Slave_5" onclick="send_LED_State('togLED_1_Slave_5','S5','1')">
                  <div class="sliderTS"></div>
                </label>
              </div>
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Invert the toggle button state.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_1_Slave_5')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
            ...
            <div style="position:relative;float: right; width: 51%;right: 0px; top: 5px;">
              <div style="position:relative; float: left;">
                <label class="switch">
                  <input type="checkbox" id="togLED_2_Slave_5" onclick="send_LED_State('togLED_2_Slave_5','S5','2')">
                  <div class="sliderTS"></div>
                </label>
              </div>
              <div class="tooltip" style="float: left; margin-left: 8px;">
                <span class="tooltiptext">Invert the toggle button state.</span>
                <button type="button" onclick="change_TglBtn_Checked('togLED_2_Slave_5')" style="height: 24px; line-height: 24px; font-size: 13px; display: inline-flex; align-items: center;">&#8644;</button>
              </div>
            </div>
          </div>
          <!-- *********************************************************************** -->
          ...
          <!-- Shows other information received from Slave 5. ************************ -->
          <p class="statusreadColor"><b><span>ULTIMO DADOS RECEBIDO : </span><span id="LTRD_Slave_5"></span></b></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR DHT11 : </span><span id="status_read_DHT11_Slave_5"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 1 : </span><span id="LED_1_State_Slave_5"></span></p>
          <p class="statusreadColor"><span>STATUS DO SENSOR 2 : </span><span id="LED_2_State_Slave_5"></span></p>
          <!-- *********************************************************************** -->
        </div>
        <!-- ======================================================================================================= -->
      </div>
    ...
    <script>
      ...
      document.getElementById("temp_Slave_4").innerHTML = "NN"; 
      document.getElementById("humd_Slave_4").innerHTML = "NN";
      document.getElementById("status_read_DHT11_Slave_4").innerHTML = "NN";
      document.getElementById("LTRD_Slave_4").innerHTML = "NN";
      document.getElementById("LED_1_State_Slave_4").innerHTML = "NN";
      document.getElementById("LED_2_State_Slave_4").innerHTML = "NN";

      document.getElementById("temp_Slave_5").innerHTML = "NN"; 
      document.getElementById("humd_Slave_5").innerHTML = "NN";
      document.getElementById("status_read_DHT11_Slave_5").innerHTML = "NN";
      document.getElementById("LTRD_Slave_5").innerHTML = "NN";
      document.getElementById("LED_1_State_Slave_5").innerHTML = "NN";
      document.getElementById("LED_2_State_Slave_5").innerHTML = "NN";
      ...
      if (!!window.EventSource) {
        ...
        source.addEventListener('allDataJSON', function(e) {
          ...
          if (obj.ID_Slave == "S4") {
            document.getElementById("status_read_DHT11_Slave_4").innerHTML = obj.StatusReadDHT11;
            if (obj.StatusReadDHT11 == "FAILED") {
              document.getElementById("status_read_DHT11_Slave_4").style.color = "red";
            } else {
              document.getElementById("status_read_DHT11_Slave_4").style.color = "#702963";
            }
            
            document.getElementById("humd_Slave_4").innerHTML = obj.Humd;
            document.getElementById("temp_Slave_4").innerHTML = obj.Temp.toFixed(2);
            
            if (obj.LED1 == true) {
              document.getElementById("LED_1_State_Slave_4").innerHTML = "ON";
            } else if (obj.LED1 == false) {
              document.getElementById("LED_1_State_Slave_4").innerHTML = "OFF";
            } else {
              document.getElementById("LED_1_State_Slave_4").innerHTML = "NN";
            }
            
            if (obj.LED2 == true) {
              document.getElementById("LED_2_State_Slave_4").innerHTML = "ON";
            } else if (obj.LED2 == false) {
              document.getElementById("LED_2_State_Slave_4").innerHTML = "OFF";
            } else {
              document.getElementById("LED_2_State_Slave_4").innerHTML = "NN";
            }
            
            document.getElementById("LTRD_Slave_4").innerHTML = time;
          }

          if (obj.ID_Slave == "S5") {
            document.getElementById("status_read_DHT11_Slave_5").innerHTML = obj.StatusReadDHT11;
            if (obj.StatusReadDHT11 == "FAILED") {
              document.getElementById("status_read_DHT11_Slave_5").style.color = "red";
            } else {
              document.getElementById("status_read_DHT11_Slave_5").style.color = "#702963";
            }
            
            document.getElementById("humd_Slave_5").innerHTML = obj.Humd;
            document.getElementById("temp_Slave_5").innerHTML = obj.Temp.toFixed(2);
            
            if (obj.LED1 == true) {
              document.getElementById("LED_1_State_Slave_5").innerHTML = "ON";
            } else if (obj.LED1 == false) {
              document.getElementById("LED_1_State_Slave_5").innerHTML = "OFF";
            } else {
              document.getElementById("LED_1_State_Slave_5").innerHTML = "NN";
            }
            
            if (obj.LED2 == true) {
              document.getElementById("LED_2_State_Slave_5").innerHTML = "ON";
            } else if (obj.LED2 == false) {
              document.getElementById("LED_2_State_Slave_5").innerHTML = "OFF";
            } else {
              document.getElementById("LED_2_State_Slave_5").innerHTML = "NN";
            }
            
            document.getElementById("LTRD_Slave_5").innerHTML = time;
          }
      ...
      function myTimer() {
        if (change_TglBtn_Disable == true) {
          ...
          if (count_to_Ctrl_TglBtn > 1000) {
            ...
            document.getElementById("togLED_1_Slave_4").disabled = false;
            document.getElementById("togLED_2_Slave_4").disabled = false;
            document.getElementById("togLED_1_Slave_5").disabled = false;
            document.getElementById("togLED_2_Slave_5").disabled = false; 
          }
        }
      }
      //------------------------------------------------------------
      ...
      function myTimerShowInfo() {
        ...
        if (count_to_Show_Info > 1500) {
          ...
          if (document.getElementById("Show_Info").innerHTML == "Sending Data to Slave 4, Please Wait...") {
            document.getElementById("Show_Info").innerHTML = "Please wait a moment for Slave 4 to reply to the message."
            return;
          }
          if (document.getElementById("Show_Info").innerHTML == "Please wait a moment for Slave 4 to reply to the message.") {
            document.getElementById("Show_Info").innerHTML = "";
            return;
          }

          if (document.getElementById("Show_Info").innerHTML == "Sending Data to Slave 5, Please Wait...") {
            document.getElementById("Show_Info").innerHTML = "Please wait a moment for Slave 5 to reply to the message."
            return;
          }
          if (document.getElementById("Show_Info").innerHTML == "Please wait a moment for Slave 5 to reply to the message.") {
            document.getElementById("Show_Info").innerHTML = "";
            return;
          }
        }
      ...
      function send_LED_State(id,slave,led_num) {
        ...
        if (slave == "S4") document.getElementById("Show_Info").innerHTML = "Sending Data to Slave 4, Please Wait...";
        if (slave == "S5") document.getElementById("Show_Info").innerHTML = "Sending Data to Slave 5, Please Wait...";
        ...
        document.getElementById("togLED_1_Slave_4").disabled = true;
        document.getElementById("togLED_2_Slave_4").disabled = true;  
        document.getElementById("togLED_1_Slave_5").disabled = true;
        document.getElementById("togLED_2_Slave_5").disabled = true;  
